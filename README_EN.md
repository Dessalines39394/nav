...
<picture>
  <source
    ...
    srcset="
      https://star-history.dera.page/svg?repos=liuzi6612/nav&type=Date&theme=dark
    "
  />
  <source
    media="(prefers-color-scheme: light)"
    srcset="
      https://star-history.dera.page/svg?repos=liuzi6612/nav&type=Date
    "
  />
  <img
    alt="Star History Chart"
    src="https://star-history.dera.page/svg?repos=liuzi6612/nav&type=Date"
  />
</picture>
